...
const CATEGORIES = ["Todos", "Diseño Web", "Diseñadores", "Marcas", "Identidad Gráfica"];

const PROJECTS_DATA = [
  //marcas
  { id: 1, title: "Concrete Workshop MX", category: "Marcas", name: "Concrete", insta: "http://www.instagram.com/concreteworkshopmx/", src: concrete, description: "Un taller de arquitectura especializado en terrazo y concreto. Con líneas de trabajo en elementos arquitectónicos, piezas de gran formato, decorativas y mobiliario urbano.", description2: "Participamos en el desarrollo de una exhibición colectiva organizada por la Universidad Anáhuac Puebla para Inédito 2024, dentro de Design Week México. Colaboramos de manera integral en la conceptualización y materialización del proyecto Modubo, llevándolo de la idea a su ejecución final."},
  { id: 2, title: "Gepetto. Diseño en madera", category: "Marcas", name: "Gepetto", insta: "http://www.instagram.com/gepetto_diseno/", src: gepetto, description: "Especializada en la fabricación de mobiliario bajo el principio de la madera como un material noble, resistente, decorativo e importante.", description2: "El equipo de Gepetto se distingue por su maestría en el trabajo artesanal de la madera. Hemos colaborado con ellos en el desarrollo del proyecto Nisa, exhibido en WantedDesign 2024. Además, han participado como asesores en distintos proyectos, destacando por su disposición para enfrentar y resolver desafíos de diseño complejos."},
  { id: 3, title: "Ladrillos de México", category: "Marcas", name: "Ladrillos", insta: "http://www.instagram.com/ladrillosdemexico/", src: ladrillos, description: "Especializada en el manejo de barro rojo, piezas de acabados arquitectónicos, piezas de diseño decorativo y luminarias.", description2: "Nuestra primera colaboración fue como fabricantes del proyecto Sayar, primera pieza presentada en ferias de diseño internacionales como el Salone Satellite en Milán 2023, Nude Feria Hábitat Valencia 2023 y Design Week Puebla 2023. Esta colaboración destaca por el trabajo conjunto con artesanos y la creación de productos con acabados rústicos y naturales."},
  { id: 4, title: "Rijaya MX", category: "Marcas", name: "Rijaya", insta: "http://www.instagram.com/rijaya.em/", src: rijaya, description: "Especializados en el diseño y la producción de Racks, lockers, muebles metálicos y estanterías.", description2: "Colaboramos en la fabricación de Nisa, una pieza exhibida en WantedDesign 2024, participando junto a una marca especializada en el trabajo del metal, destacada por su capacidad para resolver procesos técnicos complejos."},
  { id: 5, title: "Vídrios Sorribes", category: "Marcas", name: "Sorribes", insta: "http://www.instagram.com/vidriosorribes/", src: sorribes, description: "Desde Valencia, España. Una marca de artesanos maestros en el manejo del vidrio.", description2: "Colaboramos con una marca de artesanos especializados en el trabajo del vidrio, participando en el desarrollo de proyectos exhibidos en WantedDesign 2025 y en Nude Feria Hábitat Valencia."},
  { id: 6, title: "Talateca", category: "Marcas", name: "Talateca", insta: "https://www.instagram.com/talateca/", src: talateca, description: "Una tradición familiar de más de cien años dentro de la industria alfarera.", description2: "Una de las marcas con las que hemos desarrollado una colaboración cercana, participando en la producción de piezas presentadas en importantes ferias de diseño. Destaca su participación en la fabricación de “Cafar” y la colección “Cactácea”."},
  //diseño web
  ...
  return (
    <main className="colaboraciones">
      <header className="colaboraciones__header">
        ...
        >
          Trabajando con diversas marcas, diseñadores y artesanos mexicanos e internacionales, hemos desarrollado proyectos de distinta índole, que han sido exhibidos en diversas ferias de diseño y espacios culturales.
          ¿Te quieres unir?
        </motion.p>
      </header>
          ...
          {filteredProjects.map((project) => (
            ...
            >
              ...
              <div className="colaboraciones__card-content">
                ...
                {/* boton de instagram */}
                <div className="colaboraciones__card-title-container">
                  <h3 className="colaboraciones__card-title">{project.title}</h3>
                  <Link
              to={project.insta}
              className="colaboraciones__card-link-button"
            >
              <button className="colaboraciones__card-button colaboraciones__card-button_insta" />
            </Link>
