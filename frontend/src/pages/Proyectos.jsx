...
import cafarnegro2 from "../images/Proyectos/Exhibiciones/Cafar/cafarnegro2.webp";
import cafarnegro3 from "../images/Proyectos/Exhibiciones/Cafar/cafarnegro3.webp";
...
import carysFlores from "../images/Proyectos/Exhibiciones/Carys/carys6.webp";
...
import cactaceaAnimacion from "../images/Proyectos/Animaciones/CactaceaAnimacion.mp4";
...
import fervor3 from "../images/Proyectos/Producto/Joyería/fervor3.webp";


// Images from Mobiliario
import catador from "../images/Proyectos/Mobiliario/Catador/catador1.webp";
import catador2 from "../images/Proyectos/Mobiliario/Catador/catador2.webp";
import catador3 from "../images/Proyectos/Mobiliario/Catador/catador3.webp";
import catador4 from "../images/Proyectos/Mobiliario/Catador/catador4.webp";

import ypsilon from "../images/Proyectos/Mobiliario/Ypsilon/ypsilon1.webp";
import ypsilon2 from "../images/Proyectos/Mobiliario/Ypsilon/ypsilon2.webp";
import ypsilon3 from "../images/Proyectos/Mobiliario/Ypsilon/ypsilon3.webp";
import ypsilon4 from "../images/Proyectos/Mobiliario/Ypsilon/ypsilon4.webp";

import nexy from "../images/Proyectos/Mobiliario/Nexy/nexy1.webp";
import nexy2 from "../images/Proyectos/Mobiliario/Nexy/nexy2.webp";
import nexy3 from "../images/Proyectos/Mobiliario/Nexy/nexy3.webp";
import nexy4 from "../images/Proyectos/Mobiliario/Nexy/nexy4.webp";

import nomada from "../images/Proyectos/Mobiliario/Nomada/nomada1.webp";
import nomada2 from "../images/Proyectos/Mobiliario/Nomada/nomada2.webp";
import nomada3 from "../images/Proyectos/Mobiliario/Nomada/nomada3.webp";
import nomada4 from "../images/Proyectos/Mobiliario/Nomada/nomada4.webp";
import nomada5 from "../images/Proyectos/Mobiliario/Nomada/nomada5.webp";
import nomada6 from "../images/Proyectos/Mobiliario/Nomada/nomada6.webp";
...
const PROJECTS_DATA = [
  ...
  { id: 6, year: 2023, title:"Sayar", category:"Exhibiciones", src: [sayar, sayar2, sayar3, sayar4, sayar5], colaboration: "Colaboración con MUT Design.", exibition: "Salone Satellite de Milán, Italia. 2023.", exibition2: "Nude Feria Hábitat de Valencia, España. 2023.", exibition3: "Museo Regional de Cholula, México. 2023", tool: "Elaborado con Barro rojo por Ladrillos de México.", description: "Es una obra inspirada en la idea de \"explosión\" y en las cicatrices que deja, simbolizando la fuerza transformadora de la vida frente a lo artificial. A través de la ruptura y la imperfección, emerge una nueva belleza." },
  ...
  //animaciones
  { id: 26, year: 2026, title: "Nisa", category: "Animaciones", src: nisaAnimacion, type: "video", tool: "Animación realizada en Blender.", description: "Exploración de movimiento y función del taburete Nisa. La animación destaca la versatilidad y el diseño modular museográfico inspirado en la cultura mexicana." },
  { id: 27, year: 2026, title: "Sayar", category: "Animaciones", src: sayarAnimacion, type: "video", tool: "Animación realizada en Blender.", description: "Exploración de movimiento y función del florero Sayar. La animación muestra su uso como pieza decorativa y su capacidad para realzar la belleza de las flores." },
  { id: 28, year: 2026, title: "Demubo", category: "Animaciones", src: moduboAnimacion, type: "video", tool: "Animación realizada en Blender.", description: "Exploración de movimiento y función del taburete Modubo. La animación destaca la versatilidad y el diseño modular museográfico inspirado en la cultura mexicana." },
  { id: 29, year: 2025, title: "Key Hardy", category: "Animaciones", src: keyhardyAnimacion, type: "video", tool: "Animación realizada en Blender.", description: "Un personaje original, inspirado en las historias de aventureros espaciales, soldados dedicados a la protección de la humanidad o simples cazarrecompensas, que viven aventuras a lo largo de la galaxia. Primera animación que he hecho en blender, explorando un poco las diferentes funciones." },
  { id: 30, year: 2025, title: "Cafar", category: "Animaciones", src: cafarAnimacion, type: "video", tool: "Animación realizada en Blender.", description: "Exploración de movimiento y función del set de tazas para café. La animación muestra su uso como pieza para compartir y disfrutar de una buena taza de café." },
  { id: 31, year: 2026, title: "Sinergia", category: "Animaciones", src: sinergiaAnimacion, type: "video", tool: "Animación realizada en Blender.", description: "Exploración de movimiento y función de la lámpara Sinergia. La animación muestra su uso como pieza decorativa y su capacidad para realzar el espacio." },
  { id: 32, year: 2026, title: "Cactácea", category: "Animaciones", src: cactaceaAnimacion, type: "video", tool: "Animación realizada en Blender.", description: "Una reinterpretación del tótem contemporáneo, una pieza que invita a la reflexión y observación, realizada en cerámica."},
